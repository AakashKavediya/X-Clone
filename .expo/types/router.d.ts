...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/..\components\notifications` | `/..\components\trending` | `/..\components\tweet1` | `/..\components\tweet2` | `/..\components\tweet3` | `/..\components\tweet4` | `/..\components\tweet5` | `/Communities` | `/Message` | `/Notification` | `/Search` | `/_sitemap`;
